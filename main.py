...
api_hash = environ.get("5dd6bedd030fd733bb5997a1d62a9b2a", "") 
api_id = int(environ.get("24266722", ""))
bot = Client("7531297522:AAGHKt2RYE2GLnTocUnxrNNSNsdU-woMQhM", api_id=api_id, api_hash=api_hash, bot_token=bot_token)
